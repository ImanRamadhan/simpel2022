<div class="row form-horizontal">
	<div class="col-sm-12 col-lg-8 border-0">
		<div class="form-group form-group-sm row">
			...
			<div class='col-sm-7'>
				<?php
				echo form_dropdown('grafik', $graphs, '', 'class="form-control form-control-sm" id="grafik" onchange="bindingKriteria()"');?>				
			</div>
		</div>
		<div class="form-group form-group-sm row">
		...
		<div class="form-group form-group-sm row">
			<?php echo form_label('Jenis layanan', 'label_jenislayanan', array('class'=>'required col-form-label col-sm-3')); ?>
			<div class='col-sm-3'>
				<?php
		...
		<div class="form-group form-group-sm row">
			<?php echo form_label('Klasifikasi <span class="text-danger">*</span>', 'iden_instansi', array('class'=>'required col-form-label col-sm-3')); ?>
			<div class='col-sm-3'>
				<?php echo form_dropdown('klasifikasi', $klasifikasi, '', 'class="form-control form-control-sm" id="klasifikasi" ');?>
			</div>
		</div>
		<div class="form-group form-group-sm row">
			<?php echo form_label('Sub Klasifikasi <span class="text-danger">*</span>', 'iden_instansi', array('class'=>'required col-form-label col-sm-3')); ?>
			<div class='col-sm-3'>
		...
		$(document).ready(function()
		{
			...
			$('#kota').on('change', function(){
				...
				$.getJSON("<?php echo site_url('depts/get_units/'); ?>" + $(this).val(), function(data) {
					if(data)
					{
						$('#dir').empty();
						$('#dir').append($('<option></option>').attr('value', 0).text(''));
						$.each(data, function (key, entry) {
