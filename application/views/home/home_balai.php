...
<div class="row">                    
	...
	<div class="col-md-12 col-lg-6 col-xl-3">
		<div class="card">
			<div class="card-body">
				<h5 class="mt-0 mb-3">Layanan <?php echo $this->session->city; ?></h5>
				<div id="donut-layanan" class="morris-chart workloed-chart"></div>
				<ul class="list-unstyled list-group text-muted mb-0 mt-2">
					
					<li class="list-group-item border-0 d-flex justify-content-between align-items-center font-12">Status Open <a href="<?php echo site_url('tickets/list_all?status=0&tgl1='.$date_1.'&tgl2='.$date_2)?>"><span class="badge badge-primary badge-pill font-12" id="layanan_open">0</span></a></li>
					<li class="list-group-item border-0 d-flex justify-content-between align-items-center font-12">Status Replied <a href="<?php echo site_url('tickets/list_all?status=2&tgl1='.$date_1.'&tgl2='.$date_2)?>"><span class="badge badge-primary badge-pill font-12" id="layanan_replied">0</span></a></li>
					<li class="list-group-item border-0 d-flex justify-content-between align-items-center font-12">Status Closed <a href="<?php echo site_url('tickets/list_all?status=3&tgl1='.$date_1.'&tgl2='.$date_2)?>"><span class="badge badge-primary badge-pill font-12" id="layanan_closed">0</span></a></li>
	...
	<div class="col-md-12 col-lg-6 col-xl-3">
		<div class="card">
			<div class="card-body">
				...
				<ul class="list-unstyled list-group text-muted m-2">
					<li class="list-group-item border-0 d-flex justify-content-between align-items-center font-12">Status Open <a href="<?php echo site_url('tickets/list_my?status=0&tgl1='.$date_1.'&tgl2='.$date_2)?>" title="Klik untuk melihat detail"><span class="badge badge-danger badge-pill font-12" id="layanan_saya_open">0</span></a></li>
					<li class="list-group-item border-0 d-flex justify-content-between align-items-center font-12">Status Closed <a href="<?php echo site_url('tickets/list_my?status=3&tgl1='.$date_1.'&tgl2='.$date_2)?>" title="Klik untuk melihat detail"><span class="badge badge-success badge-pill font-12" id="layanan_saya_closed">0</span></a></li>
...
<?php $this->load->view("home/home_balai_js"); ?>
