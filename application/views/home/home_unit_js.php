...
$(document).ready(function()
{
	...
	$.getJSON('<?php echo site_url('dashboard_unit/layanan_all');?>', function (data) {
	...
	/*$.getJSON('<?php echo site_url('dashboard_unit/layanan_total');?>', function (data) {
		$('#layanan_total').html(data);
	});
	
	$.getJSON('<?php echo site_url('dashboard_unit/layanan_open');?>', function (data) {
		$('#layanan_open').html(data);
	});
	
	$.getJSON('<?php echo site_url('dashboard_unit/layanan_replied');?>', function (data) {
		$('#layanan_replied').html(data);
	});
	
	$.getJSON('<?php echo site_url('dashboard_unit/layanan_closed');?>', function (data) {
		$('#layanan_closed').html(data);
	});*/
	
	$.getJSON('<?php echo site_url('dashboard_unit/layanan_saya_open');?>', function (data) {
		$('#layanan_saya_open').html(data);
	});
	
	$.getJSON('<?php echo site_url('dashboard_unit/layanan_saya_closed');?>', function (data) {
		$('#layanan_saya_closed').html(data);
	});
	
	$.getJSON('<?php echo site_url('dashboard_unit/layanan_saya_total');?>', function (data) {
		$('#layanan_saya_total').html(data);
	});
	
	$.getJSON('<?php echo site_url('dashboard_unit/layanan_saya');?>', function (data) {
	...
	//rujukan
	$.getJSON('<?php echo site_url('dashboard_unit/rujukan_masuk');?>', function (data) {
		$('#rujukan_masuk').html(data);
	});
	
	/*$.getJSON('<?php echo site_url('dashboard_unit/rujukan_masuk_blm_dijawab');?>', function (data) {
		$('#rujukan_masuk_blm_dijawab').html(data);
	});
	
	$.getJSON('<?php echo site_url('dashboard_unit/rujukan_masuk_sudah_dijawab');?>', function (data) {
		$('#rujukan_masuk_sudah_dijawab').html(data);
	});*/
	
	$.getJSON('<?php echo site_url('dashboard_unit/rujukan_masuk_chart');?>', function (data) {
	...
	$.getJSON('<?php echo site_url('dashboard_unit/rujukan_keluar');?>', function (data) {
		$('#rujukan_keluar').html(data);
	});
	
	$.getJSON('<?php echo site_url('dashboard_unit/rujukan_keluar_chart');?>', function (data) {
	...
	/*$.getJSON('<?php echo site_url('dashboard_unit/rujukan_keluar_blm_dijawab');?>', function (data) {
		$('#rujukan_keluar_blm_dijawab').html(data);
	});
	
	$.getJSON('<?php echo site_url('dashboard_unit/rujukan_keluar_sudah_dijawab');?>', function (data) {
		$('#rujukan_keluar_sudah_dijawab').html(data);
	});*/
	
	$.getJSON('<?php echo site_url('dashboard_unit/belum_tl');?>', function (data) {
