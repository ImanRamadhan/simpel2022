		...
		<div class="card">
			<div class="card-body">
				...
				<ul class="list-unstyled list-group text-muted m-2">
					...
					<li class="list-group-item border-0 d-flex justify-content-between align-items-center font-12">Rujukan Masuk - Sudah Dijawab <a href="<?php echo site_url('rujukan/list_masuk?status=1&tgl1=' . $date_1 . '&tgl2=' . $date_2) ?>" title="Klik untuk melihat detail"><span class="badge badge-success badge-pill font-12" id="rujukan_masuk_sudah_dijawab">0</span></a></li>
		...
		<div class="card">
			<div class="card-body">
				...
				<ul class="list-unstyled list-group text-muted m-2">
					...
					<li class="list-group-item border-0 d-flex justify-content-between align-items-center font-12">Sudah di-TL <a href="<?php echo site_url('tickets/list_all?kota=PUSAT&tl=1&tgl1=' . $date_1 . '&tgl2=' . $date_2) ?>" title="Klik untuk melihat detail"><span class="badge badge-success badge-pill font-12" id="pusat_sudah_tl">0</span></a></li>
		...
		<div class="card">
			<div class="card-body">
				...
				<ul class="list-unstyled list-group text-muted m-2">
					...
					<li class="list-group-item border-0 d-flex justify-content-between align-items-center font-12">Sudah di-Feedback <a href="<?php echo site_url('tickets/list_all?kota=PUSAT&fb=1&tgl1=' . $date_1 . '&tgl2=' . $date_2) ?>" title="Klik untuk melihat detail"><span class="badge badge-success badge-pill font-12" id="pusat_sudah_fb">0</span></a></li>
		...
		<div class="card">
			<div class="card-body">
				...
				<ul class="list-unstyled list-group text-muted m-2">
					...
					<li class="list-group-item border-0 d-flex justify-content-between align-items-center font-12">Status Closed <a href="<?php echo site_url('tickets/list_my?status=3&tgl1=' . $date_1 . '&tgl2=' . $date_2) ?>" title="Klik untuk melihat detail"><span class="badge badge-success badge-pill font-12" id="layanan_saya_status_closed">0</span></a></li>
...
<div class="row">
	<div class="col-md-12 col-lg-6 col-xl-3">
		<div class="card">
			<div class="card-body">
				<h5 class="mt-0 mb-3">PPID</h5>
				<div id="donut-ppid" class="morris-chart workloed-chart"></div>
				<ul class="list-unstyled list-group text-muted mb-0 mt-2">
					<li class="list-group-item border-0 d-flex justify-content-between align-items-center font-12">PUSAT <a href="<?php echo site_url('tickets/list_all?kota=PUSAT&tgl1=' . $date_1 . '&tgl2=' . $date_2) ?>" title="Klik untuk melihat detail"><span class="badge badge-primary badge-pill font-12" id="ppid_pusat">0</span></a></li>
					<li class="list-group-item border-0 d-flex justify-content-between align-items-center font-12">CC <a href="<?php echo site_url('tickets/list_all?kota=CC&tgl1=' . $date_1 . '&tgl2=' . $date_2) ?>" title="Klik untuk melihat detail"><span class="badge badge-primary badge-pill font-12" id="ppid_cc">0</span></a></li>
					<li class="list-group-item border-0 d-flex justify-content-between align-items-center font-12">BALAI <a href="<?php echo site_url('tickets/list_all?kota=BALAI&tgl1=' . $date_1 . '&tgl2=' . $date_2) ?>" title="Klik untuk melihat detail"><span class="badge badge-primary badge-pill font-12" id="ppid_balai">0</span></a></li>
					<li class="list-group-item border-0 d-flex justify-content-between align-items-center font-12">TOTAL LAYANAN <a href="<?php echo site_url('tickets/list_all?kota=ALL&tgl1=' . $date_1 . '&tgl2=' . $date_2) ?>" title="Klik untuk melihat detail"><span class="badge badge-primary badge-pill font-12" id="ppid_total">0</span></a></li>
	...
	<div class="col-md-12 col-lg-6 col-xl-3">
		<div class="card">
			<div class="card-body">
				<h5 class="mt-0 mb-3">SP4N</h5>
				<div id="donut-sp4n" class="morris-chart workloed-chart"></div>
				<ul class="list-unstyled list-group text-muted mb-0 mt-2">
					<li class="list-group-item border-0 d-flex justify-content-between align-items-center font-12">PUSAT <a href="<?php echo site_url('tickets/list_all?kota=PUSAT&tgl1=' . $date_1 . '&tgl2=' . $date_2) ?>" title="Klik untuk melihat detail"><span class="badge badge-primary badge-pill font-12" id="sp4n_pusat">0</span></a></li>
					<li class="list-group-item border-0 d-flex justify-content-between align-items-center font-12">CC <a href="<?php echo site_url('tickets/list_all?kota=CC&tgl1=' . $date_1 . '&tgl2=' . $date_2) ?>" title="Klik untuk melihat detail"><span class="badge badge-primary badge-pill font-12" id="sp4n_cc">0</span></a></li>
					<li class="list-group-item border-0 d-flex justify-content-between align-items-center font-12">BALAI <a href="<?php echo site_url('tickets/list_all?kota=BALAI&tgl1=' . $date_1 . '&tgl2=' . $date_2) ?>" title="Klik untuk melihat detail"><span class="badge badge-primary badge-pill font-12" id="sp4n_balai">0</span></a></li>
					<li class="list-group-item border-0 d-flex justify-content-between align-items-center font-12">TOTAL LAYANAN <a href="<?php echo site_url('tickets/list_all?kota=ALL&tgl1=' . $date_1 . '&tgl2=' . $date_2) ?>" title="Klik untuk melihat detail"><span class="badge badge-primary badge-pill font-12" id="sp4n_total">0</span></a></li>
