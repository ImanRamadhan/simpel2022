		...
		<div class="page-title-box">
			<div class="float-right">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Lapsing Komoditas</li>
				</ol>
			</div>
...
$(document).ready(function()
{
	...
	if($.remember({ name: 'lapsing.tgl1' }) != null) 
	{
		$('#tgl1').val($.remember({ name: 'lapsing.tgl1' }));
	}
	else
	{
	...
	if($.remember({ name: 'lapsing.tgl2' }) != null) 
	{
		$('#tgl2').val($.remember({ name: 'lapsing.tgl2' }));
	}
	else
	{
		...
		<div class="card ">
			...
			<div class="card-body">
                ...
                <?php 
                    ...
                    $this->load->view("lapsingv2/lapsing_komoditas_header");
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<tr>
							...
							?>
							<td class='text-right'><?php echo $array[0];?></td>
							<td class='text-right'><?php echo round($array[1]*100,2); ?>%</td>
							<td class='text-right'><?php echo $array[2];?></td>
							<td class='text-right'><?php echo round($array[3]*100,2); ?>%</td>
							<td class='text-right'><?php echo $array[4];?></td>
							<td class='text-right'><?php echo round($array[5]*100,2); ?>%</td>
						...
						<tr>
							<td>JUMLAH</td>
							<td class='text-right'><?php echo $jml_i; ?></td>
							<td class='text-right'><?php echo round($persen_i*100,2); ?>%</td>
							<td class='text-right'><?php echo $jml_p; ?></td>
							<td class='text-right'><?php echo round($persen_p*100,2); ?>%</td>
							<td class='text-right'><?php echo $jml_t; ?></td>
							<td class='text-right'><?php echo round($persen_t*100,2); ?>%</td>
						</tr>
						</tfoot>
						</tbody>
						</table>
