		...
		<div class="page-title-box">
			<div class="float-right">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Layanan Pengajuan Keberatan</li>
				</ol>
			</div>
			<h4 class="page-title">Layanan Pengajuan Keberatan</h4>
		</div>
	</div>
</div>
		...
		<div class="card ">
			...
			<div class="card-body">
				<div id="title_bar" class="btn-toolbar float-right">
					...
					<a href="<?php echo site_url("drafts/create_keberatan"); ?>" class="btn btn-info btn-sm btn-round"><i class="fa fa-plus"></i> <?php echo $this->lang->line($controller_name . '_new'); ?> </a>
					
				</div>
				<?php $this->load->view("partial/search"); ?>
				
				<h4 class="text-center">REGISTER KEBERATAN</h4>
				<div id="toolbar">
...
$(document).ready(function()
{
	...
	$('#export').on('click', function(e){
		...
		window.location.href = "<?php echo site_url('excels_ppid/export_excel_keberatan');?>?tgl1="+ tgl1 +"&tgl2="+ tgl2 +"&kota="+kota+"&search=" + search;
		return false;
	});
});
</script>
