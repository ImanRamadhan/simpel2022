...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td align="justify">
		Berdasarkan permohonan informasi pada tanggal <?php echo convert_date3($ppid_info->tgl_diterima);	?> dengan nomor pendaftaran* <?php echo $item_info->trackid; ?><br />
		Kami menyampaikan kepada Saudara/i:
		<br />
		</td>
	</tr>
	<tr>
		<td height="5px" valign="middle">
	...
	<tr>
		<td>
			<table border="0" cellspacing="2" cellpadding="1" width="90%">
				...
				<tr>
					<td width="200px">No.Telp/Email</td>
					<td width="10px">:</td>
					<td>
					<?php 
					$arr = array();
	...
	<tr><td>
		...
		<table class="mytable" border="0" cellspacing="0" cellpadding="1" width="100%">
			<tr>
				<td class="mytd" width="5%" align="center"><b>No.</b></td><td class="mytd" width="30%" align="center"><b>Hal-hal terkait Informasi Publik</b></td><td class="mytd" colspan="2" align="center"><b>Keterangan</b></td>
			</tr>
			<tr>
				<td class="mytd" valign="top" align="center">1.</td><td class="mytd" valign="top">Penguasaan Informasi Publik**</td>
				<td class="mytd" colspan="2">
				
				<table width="100%">
					<tr>
						<td width="5%" valign="top"><input type="checkbox" <?php echo $ppid_info->penguasaan_kami?'checked':''; ?> /></td><td width="95%">Kami:<br /><?php echo $ppid_info->penguasaan_kami_teks;?>
						
						</td>
					</tr>
					<tr>
						<td width="5%" valign="top"><input type="checkbox" <?php echo $ppid_info->penguasaan_badan_lain?'checked':''; ?> /></td><td width="95%">Badan Publik Lain<br /><?php echo $ppid_info->nama_badan_lain;?>
						</td>
					</tr>
				</table>
			...
			<tr>
				<td class="mytd" valign="top" align="center">2.</td><td class="mytd" valign="top">Bentuk fisik yang tersedia**</td>
				<td class="mytd" colspan="2">
			...
			<tr>
				<td class="mytd" valign="top" align="center">3.</td><td class="mytd" valign="top">Biaya yang dibutuhkan***</td>
			...
			<tr>
				<td class="mytd" valign="top"></td><td class="mytd" valign="top"></td>
			...
			<tr>
				<td class="mytd" valign="top" align="center">4.</td><td class="mytd" valign="top">Waktu penyediaan</td><td class="mytd" colspan="2"> <?php echo !empty($ppid_info->waktu_penyediaan)?$ppid_info->waktu_penyediaan:" - ";?> Hari Kerja </td>
			</tr>
			<tr>
				<td class="mytd" valign="top" align="center">5.</td><td class="mytd" colspan="3" valign="top">Penjelasan penghitaman/pengaburan Informasi yang dimohon**** (tambahkan kertas bila perlu)<br /><br />
	...
	<tr>
		<td><b>B. Informasi tidak dapat diberikan karena:**</b><br />
	...
	<tr>
		<td>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>*</td><td>Diisi sesuai dengan nomor pendaftaran pada formulir permohonan.</td>
				</tr>
				<tr>
					<td>**</td><td>Pilih salah satu dengan memberi tanda (<input type="checkbox" checked />).</td>
				</tr>
				<tr>
					<td>***</td><td>Biaya penyalinan (fotokopi atau disket) dan/atau biaya pengiriman (khusus kurir dan pos) sesuai dengan standar biaya yang telah ditetapkan.</td>
				</tr>
				<tr>
					<td>****</td><td>Jika ada penghitaman informasi dalam suatu dokumen, maka diberikan alasan penghitamannya.</td>
				</tr>
				<tr>
					<td>*****</td><td>Diisi dengan keterangan waktu yang jelas untuk menyediakan informasi yang diminta.</td>
				</tr>
			</table>
