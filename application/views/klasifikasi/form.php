		...
		<div class="card">
				...
				<div class="row">
						<div class="col-sm-12 col-lg-12">
							...
							<div class="form-group form-group-sm row">
								...
								<?php echo form_label('Nama Klasifikasi <span class="text-danger">*</span>', 'name', array('class'=>'col-form-label col-sm-4')); ?>
			...
			<div class="card-footer">
					...
					<div class="text-center">
						...
						<a class="btn btn-sm btn-light" href="<?php echo site_url('klasifikasis'); ?>"> Batal</a>
					</div>
			</div>
		</div>
	...
	$('#job_form').validate($.extend({
		submitHandler: function(form)
		{
			$(form).ajaxSubmit({
				...
				success: function(response)
				{
					...
					setTimeout(function(){window.location.href = "<?php echo site_url('klasifikasis'); ?>";}, 3000);
				},
				dataType: 'json'
			});
		},
		...
		rules:
		{
			nama: { 
				...
				<?php if(!$edit):?>
				remote: {
					url: "<?php echo site_url('klasifikasis/ajax_check_klasifikasi')?>",
					type: "post",
		...
		messages: 
		{
			...
			{ 
				...
				remote: "Nama Klasifikasi sudah digunakan"
			},
