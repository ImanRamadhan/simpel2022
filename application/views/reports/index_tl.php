...
<section class="content-header">
  ...
  <ol class="breadcrumb">
	...
	<li class="active">Indeks TL Rujukan</li>
  </ol>
</section>
	...
	<div class="col-xs-12">
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<?php echo form_open($controller_name . '/index_tl', array('id'=>'score_form', 'class'=>'form-horizontal')); ?>
				<div class="row">
					...
					<table id="table" class="table table-striped table-bordered">
						<thead>
							<tr>
								<th>No.</th>
								<th>Balai</th>
								<th class="text-center">Jml Layanan Dirujuk</th>
								<th class="text-center">Jml TL Memenuhi SLA</th>
						...
						<tbody>
							...
							<tr>
								...
								<td align="center"><?php echo $row['jml_dirujuk']; ?></td>
								<td align="center"><?php echo $row['jml_dirujuk_tl']; ?></td>
								<td align="center"><?php echo $row['index_tl']; ?></td>
