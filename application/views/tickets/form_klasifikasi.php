...
<div class="row">
	<div class="col-sm-12 col-lg-6">
		...
		<div class="form-group form-group-sm row">
			<?php echo form_label('Jenis Komoditi <span class="text-danger">*</span>', 'iden_instansi', array('class'=>'required col-form-label col-sm-4')); ?>
			<div class='col-sm-6'>
		...
		<div class="form-group form-group-sm row">
			...
			<div class='col-sm-4'>
				<?php echo form_dropdown('jenis', $sumberdata, $item_info->jenis, 'class="form-control form-control-sm" id="jenis" ');?>
			</div>
		</div>
		<div class="form-group form-group-sm row">
