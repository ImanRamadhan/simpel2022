		...
		<div class="page-title-box">
			<div class="float-right">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Performa SLA Sudah TL</li>
				</ol>
			</div>
			<h4 class="page-title">Performa SLA Layanan Sudah TL</h4>
		</div>
	</div>
</div>
...
$(document).ready(function()
{
    ...
    table_support.init({
        resource: '<?php echo site_url("tickets_sla_perform");?>',
			...
			<div class="card-body">
				...
				<div id="toolbar">
					<div class="float-left form-inline" role="toolbar">
						...
						&nbsp;SLA : &nbsp;
						<?php echo form_dropdown('sla', array('ALL'=> 'ALL', 'meet'=>'Memenuhi','notmeet'=>'Tidak Memenuhi'), '', array('id'=>'sla', 'class'=>'selectpicker show-menu-arrow', 'data-none-selected-text'=>'All', 'data-style'=>'btn-soft-info btn-sm', 'data-width'=>'fit')); ?>
					</div>
