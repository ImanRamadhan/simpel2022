...
<div class="tab-pane p-3 border rounded-lg" id="formulir" role="tabpanel">
	<div class="row">
		<div class="col-sm-12 col-lg-6">
			...
			<?php if (!empty($ppid_info->alasan_keberatan)): ?>
				<div class="form-group form-group-sm row">
					...
					<div class='col-sm-9'>
						<ul>
							<?php $r = rand(1000, 9999); ?>
							<li>Formulir Keberatan <a class="" target="_blank" href="<?php echo site_url('ppid/print_ppid_form6/' . $item_info->id . '?r=' . $r) ?>"><i class="fa fa-file-pdf"></i> pdf</a>&nbsp; <a class="" target="_blank" href="<?php echo site_url('ppid/ppid_word6/' . $item_info->id . '?r=' . $r) ?>"><i class="fa fa-file-word"></i> docx</a></li>
			...
			<?php elseif (!empty($ppid_info->info_blm_didoc)): ?>
				<div class="form-group form-group-sm row">
					<?php echo form_label('Formulir Keberatan', 'unduh', array('class' => 'col-form-label col-sm-3')); ?>
					<div class='col-sm-9'>
						<ul>
			...
			<?php elseif (!empty($ppid_info->alasan_ditolak)): ?>
				<div class="form-group form-group-sm row">
					<?php echo form_label('Formulir Keberatan', 'unduh', array('class' => 'col-form-label col-sm-3')); ?>
					<div class='col-sm-9'>
						<ul>
			...
			<?php elseif ($ppid_info->is_lengkap == 'Tidak Lengkap'): ?>
				<div class="form-group form-group-sm row">
					<?php echo form_label('Formulir Keberatan', 'unduh', array('class' => 'col-form-label col-sm-3')); ?>
					<div class='col-sm-9'>
						<ul>
			...
			<?php else: ?>
				<div class="form-group form-group-sm row">
					...
					<div class='col-sm-9'>
						<ul>
							<li>Formulir Permintaan Informasi Publik <a class="" target="_blank" href="<?php echo site_url('ppid/print_ppid_form1/' . $item_info->id . '?r=' . $r) ?>"><i class="fa fa-file-pdf"></i> pdf</a>&nbsp; <a class="" target="_blank" href="<?php echo site_url('ppid/ppid_word1/' . $item_info->id . '?r=' . $r) ?>"><i class="fa fa-file-word"></i> docx</a>&nbsp; <a class="" target="_blank" href="<?php echo site_url('ppid/ppid_word1/' . $item_info->id . '?r=' . $r) ?>"><i class="fa fa-file-word"></i> *docx*</a></li>
							<!--<li>Formulir Tanda Terima Permohonan Informasi PPID <a class="" target="_blank" href="<?php echo site_url('ppid/print_ppid_form2/' . $item_info->id . '?r=' . $r) ?>"> <i class="fa fa-file-pdf"></i> pdf</a>&nbsp; <a class="" target="_blank" href="<?php echo site_url('ppid/ppid_word2/' . $item_info->id . '?r=' . $r) ?>"><i class="fa fa-file-word"></i> docx</a></li>-->

							<li>Formulir Pemberitahuan Tertulis PPID <a class="" target="_blank" href="<?php echo site_url('ppid/print_ppid_form4/' . $item_info->id . '?r=' . $r) ?>"> <i class="fa fa-file-pdf"></i> pdf</a>&nbsp; <a class="" target="_blank" href="<?php echo site_url('ppid/ppid_word4/' . $item_info->id . '?r=' . $r) ?>"><i class="fa fa-file-word"></i> docx</a>&nbsp; <a class="" target="_blank" href="<?php echo site_url('ppid/ppid_word4/' . $item_info->id . '?r=' . $r) ?>"><i class="fa fa-file-word"></i> *docx*</a></li>
							<li>Tanggapan Tertulis <a class="" target="_blank" href="<?php echo site_url('ppid/print_ppid_form5/' . $item_info->id . '?r=' . $r) ?>"> <i class="fa fa-file-pdf"></i> pdf</a>&nbsp; <a class="" target="_blank" href="<?php echo site_url('ppid/ppid_word5/' . $item_info->id . '?r=' . $r) ?>"><i class="fa fa-file-word"></i> docx</a>&nbsp; </li>

							<?php if (!empty($ppid_info->pengecualian_pasal17) || !empty($ppid_info->pengecualian_pasal_lain)): ?>
								<li>Formulir Penolakan <a class="" target="_blank" href="<?php echo site_url('ppid/print_ppid_form3/' . $item_info->id . '?r=' . $r) ?>"> <i class="fa fa-file-pdf"></i> pdf</a> &nbsp; <a class="" target="_blank" href="<?php echo site_url('ppid/ppid_word5/' . $item_info->id . '?r=' . $r) ?>"><i class="fa fa-file-word"></i> docx</a></li>
							<?php endif; ?>

							<!--
							KAK 2024 - Sesuai matrix 
							<li>Formulir Ketidaklengkapan &nbsp; <a class="" target="_blank" href="<?php echo site_url('ppid/ppid_word3/' . $item_info->id . '?r=' . $r) ?>"><i class="fa fa-file-word"></i> *docx*</a></li>
							<li>Surat Keputusan ttg Penolakan &nbsp; <a class="" target="_blank" href="<?php echo site_url('ppid/ppid_word5/' . $item_info->id . '?r=' . $r) ?>"><i class="fa fa-file-word"></i> *docx*</a></li>
	...
	<div class="row">
		...
		<div class="col-sm-12 col-lg-6">
			...
			<div class="form-group form-group-sm row">
				...
				<div class="col-sm-8">
					...
					<table>
						<tr>
							<td>Biaya Penyalinan</td>
							<td>: Rp. </td>
							<td align="right"><?php echo !empty($ppid_info->biaya_penyalinan) ? number_format($ppid_info->biaya_penyalinan, 0) : '-'; ?></td>
						</tr>
						<tr>
							<td>Jml Lembaran</td>
							<td>: </td>
							<td align="right"><?php echo $ppid_info->biaya_penyalinan_lbr; ?></td>
						</tr>
						<tr>
							<td>Biaya Pengiriman</td>
							<td>: Rp. </td>
							<td align="right"><?php echo !empty($ppid_info->biaya_pengiriman) ? number_format($ppid_info->biaya_pengiriman, 0) : '-'; ?></td>
						</tr>
						<tr>
							<td>Biaya Lain</td>
							<td>: Rp. </td>
							<td align="right"><?php echo !empty($ppid_info->biaya_lain) ? number_format($ppid_info->biaya_lain, 0) : '-'; ?></td>
						</tr>
						<tr>
							<td>Total Biaya</td>
							<td>: Rp. </td>
							<td align="right"><?php echo !empty($ppid_info->biaya_total) ? number_format($ppid_info->biaya_total, 0) : '-'; ?></td>
						</tr>
		...
		<div class="col-sm-12 col-lg-6">
			...
			<h5>Kelengkapan</h5>
			<div class="form-group form-group-sm row">
				<?php echo form_label('Kelengkapan',  'kelengkapan_label', array('for' => 'message', 'class' => 'col-form-label col-sm-3')); ?>
				<div class="col-sm-8">
					<p class="form-control-plaintext">
						<?php echo $ppid_info->is_lengkap; ?>
					</p>
				</div>
			</div>
