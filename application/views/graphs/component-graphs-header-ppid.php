<div class="row form-horizontal">
	<div class="col-sm-12 col-lg-8 border-0">
		...
		<div class="form-group form-group-sm row">
			...
			<?php else: ?>
				<input type="hidden" name="kota" id="kota" value="<?php echo $this->session->city; ?>" />
			<?php endif; ?>
			...
			<div class="form-group form-group-sm row"  id="divdatasource">
				...
				<div class='col-sm-3'>
					<?php
					echo form_dropdown('datasource', $datasources, 'PPID', 'class="form-control form-control-sm" id="datasource"');?>
				</div>
			</div>
			<div class="form-group form-group-sm row">
