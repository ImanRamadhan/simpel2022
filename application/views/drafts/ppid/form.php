...
<?php echo form_open($controller_name . '/save_ppid/' . $item_info->id, array('id' => 'ticket_form', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data')); ?>
<div class="row">
	<div class="col-lg-12">
		...
		<div class="card">
			...
			<div class="card-body">
				<ul class="nav nav-tabs border-0" role="tablist">
					...
					<li class="nav-item">
						<a class="nav-link border rounded-lg border-bottom-0" data-toggle="tab" href="#tabppid" role="tab" id="tabppid_">Form Permintaan Informasi Publik</a>
					</li>
				...
				<div class="tab-content bg-white h-80">
					...
					<div class="tab-pane p-3 border rounded-lg" id="tabklasifikasi" role="tabpanel">
						<?php $this->load->view('drafts/ppid/form_klasifikasi'); ?>
					</div>
					<div class="tab-pane p-3 border rounded-lg" id="tabtindaklanjut" role="tabpanel">
						<?php $this->load->view('drafts/ppid/form_tindaklanjut'); ?>
					</div>
					...
					<div class="tab-pane p-3 border rounded-lg" id="tabppid" role="tabpanel">
						<?php $this->load->view('drafts/ppid/form_ppid'); ?>
					</div>
			...
			<div class="card-footer">
				<div class="text-center">
					...
					<input type="hidden" name="formtype" id="formtype" value="2" />
			...
			$.ajax({
				...
				success: function(response) {
					...
					if (response.id != -1) {
						...
						setTimeout(function() {
							window.location.href = "<?php echo site_url('drafts/edit/'); ?>" + response.id;
						}, 1000);
					}
								...
								if (result) {
									$.ajax({
										...
										success: function(data) {
											...
											setTimeout(function() {
												window.location.href = "<?php echo site_url('tickets/view/'); ?>" + data.id;
											}, 1000);
										}
									});
								} else {
