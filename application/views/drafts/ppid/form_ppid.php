...
<div class="row">
	<div class="col-sm-12 col-lg-6">
		...
		<div class="form-group form-group-sm row">
			...
			echo form_label('Cara memperoleh informasi <span class="text-danger">*</span>', 'rincian', array('for' => 'message', 'class' => 'col-form-label col-sm-3')); ?>
			<div class="col-sm-8">
		...
		<div class="form-group form-group-sm row">
			<?php echo form_label('Penguasaan Informasi Publik <span class="text-danger">*</span>', 'rincian', array('for' => 'message', 'class' => 'col-form-label col-sm-3')); ?>
			<div class="col-sm-9">
				<div class="form-check">
		...
		<div class="form-group form-group-sm row">
			...
			echo form_label('Bentuk Fisik Yang Tersedia <span class="text-danger">*</span>', 'rincian', array('for' => 'message', 'class' => 'col-form-label col-sm-3')); ?>
			<div class="col-sm-8">
		...
		<div class="form-group form-group-sm row">
			<?php echo form_label('Penyediaan informasi yang belum didokumentasikan dilakukan dalam jangka waktu <span class="text-danger">*</span>', 'rincian', array('for' => 'message', 'class' => 'col-form-label col-sm-3')); ?>
			<div class="col-sm-4">
				<div class="input-group mb-2">
