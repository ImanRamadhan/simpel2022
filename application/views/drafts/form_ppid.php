...
<h4>Formulir Permohonan Informasi Publik</h4>
<div class="row">
	<div class="col-sm-12 col-lg-6">
		<div class="form-group form-group-sm row">
			<?php echo form_label('Diterima Tanggal', 'rincian', array('for'=>'message', 'class'=>'col-form-label col-sm-3')); ?>
			<div class="col-sm-4">
		...
		<div class="form-group form-group-sm row">
			<?php echo form_label('Melalui', 'rincian', array('for'=>'message', 'class'=>'col-form-label col-sm-3')); ?>
			<div class="col-sm-8">
				<?php echo form_input(array(
				'class'=>'form-control form-control-sm', 
				'name'=>'diterima_via', 
		...
		<div class="form-group form-group-sm row">
			<?php echo form_label('Rincian Informasi yang dibutuhkan', 'rincian', array('for'=>'message', 'class'=>'col-form-label col-sm-3')); ?>
			<div class="col-sm-8">
		...
		<div class="form-group form-group-sm row">
			<?php echo form_label('Tujuan Penggunaan Informasi', 'tujuan', array('for'=>'message', 'class'=>'col-form-label col-sm-3')); ?>
			<div class="col-sm-8">
				<?php echo form_textarea(array(
				'class'=>'form-control form-control-sm', 
				'name'=>'tujuan', 
		...
		<div class="form-group form-group-sm row">
			<?php echo form_label('Waktu Penyediaan', 'rincian', array('for'=>'message', 'class'=>'col-form-label col-sm-3')); ?>
			<div class="col-sm-4">
		...
		<div class="form-group form-group-sm row">
			<?php echo form_label('Nama Pejabat PPID', 'rincian', array('for'=>'message', 'class'=>'col-form-label col-sm-3')); ?>
			<div class="col-sm-8">
				<?php echo form_input(array(
				'class'=>'form-control form-control-sm', 
	...
	<div class="col-sm-12 col-lg-6">
		...
		<div class="form-group form-group-sm row">
			...
			<div class="col-sm-8">
				...
				'id'=>'tt_perihal', 
				'rows'=>4,
				'value'=>(empty($ppid_info->tt_perihal)?'Tanggapan Permohonan Informasi Publik':'')
				));?>
			</div>
		</div>
		<div class="form-group form-group-sm row">
		...
		<div class="form-group form-group-sm row">
			<?php echo form_label('Keputusan', 'rincian', array('for'=>'message', 'class'=>'col-form-label col-sm-3')); ?>
			<div class="col-sm-5">
...
{
	<?php if($mode == 'ADD' || $ppid_info->keputusan == 'Dikabulkan sebagian'||$ppid_info->keputusan == 'Ditolak'): ?>
