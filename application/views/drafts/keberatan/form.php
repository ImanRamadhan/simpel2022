...
<?php echo form_open($controller_name . '/save_keberatan/' . $item_info->id, array('id'=>'ticket_form', 'class'=>'form-horizontal','enctype'=>'multipart/form-data')); ?>
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="card">
				...
				<ul class="nav nav-tabs border-0" role="tablist">
					...
					<li class="nav-item">
						<a class="nav-link border rounded-lg border-bottom-0" data-toggle="tab" href="#tabppid2" role="tab" id="tabppid2_">Pengajuan Keberatan</a>
					</li>
				</ul>
				...
				<div class="tab-content bg-white h-80">
					...
					<div class="tab-pane p-3 border rounded-lg" id="tabklasifikasi" role="tabpanel">
						<?php $this->load->view('drafts/keberatan/form_klasifikasi'); ?>
					</div>
					<div class="tab-pane p-3 border rounded-lg" id="tabtindaklanjut" role="tabpanel">
						<?php $this->load->view('drafts/keberatan/form_tindaklanjut'); ?>
					</div>
				...
				<div class="card-footer">
					<div class="text-center">
						...
						<input type="hidden" name="formtype" id="formtype" value="3" />
...
$(document).ready(function()
{
	...
	$('#ticket_form').validate($.extend({
			...
			rules:
			{
				...
				//no_reg_keberatan: "required",
				kuasa_nama: "required",
				kuasa_alamat: "required",
				kuasa_telp: "required",
				kuasa_email: "required",
				kasus_posisi: "required",
				tgl_tanggapan: "required",
				nama_petugas: "required",
				keberatan_tgl: "required",
				keberatan_no: "required",
				keberatan_perihal: "required",
				keberatan_isi_surat: "required",
				keberatan_nama_pejabat: "required"
			...
			messages: 
			{
				...
				//no_reg_keberatan: "harus diisi",
				kuasa_nama: "Nama Kuasa Pemohon harus diisi",
				kuasa_alamat: "Alamat Kuasa Pemohon harus diisi",
				kuasa_telp: "No. Telp Kuasa Pemohon harus diisi",
				kuasa_email: "Email Kuasa Pemohon harus diisi",
				kasus_posisi: "Kasus Posisi harus diisi",
				tgl_tanggapan: "Tanggal Tanggapan Akan Diberikan harus diisi",
				nama_petugas: "Petugas Penerima Informasi Keberatan harus diisi",
				keberatan_tgl: "Tanggal Tanggapan harus diisi",
				keberatan_no: "Nomor Tanggapan harus diisi",
				keberatan_perihal: "Perihal Tanggapan harus diisi",
				keberatan_isi_surat: "Isi Tanggapan harus diisi",
				keberatan_nama_pejabat: "Pejabat penandatangan surat harus diisi"
