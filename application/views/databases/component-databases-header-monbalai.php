<?php echo form_open($controller_name . '/monbalai_data', array('id'=>'database_form', 'class'=>'form-horizontal')); ?>
<div class="row">
	<div class="col-sm-12 col-lg-12 border-0">
			...
			<div class="form-group form-group-sm row">
				...
				<div class='col-sm-10'>
					<button class="btn btn-warning btn-sm" id="process_btn"> <i class="fa fa-search"></i> Lihat Data</button>
