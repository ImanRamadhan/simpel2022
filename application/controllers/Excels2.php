...
class Excels2 extends CI_Controller {
	...
	public function download_layanan()
	{
        ...
        header('Content-Type: application/vnd.ms-excel');
		header('Content-Disposition: attachment;filename=Layanan_'.$kota.'_'.$tgl1.'_s.d_'.$tgl2.'.xlsx'); 
		header('Cache-Control: max-age=0');
        $writer->save('php://output');
    ...
    public function download_lapsing(){
        ...
        $spreadsheet = IOFactory::load(realpath(APPPATH . '/doc_templates/template01_lapsing.xls'));
	...
	public function print_lapsing_body($sheet, &$worksheet){
		...
		$worksheet->fromArray($data['farmakologi'],NULL,'C33');
		$worksheet->fromArray($data['mutu'],NULL,'K33');
		$worksheet->fromArray($data['legalitas'],NULL,'S33');
		$worksheet->fromArray($data['penandaan'],NULL,'AA33');
		$worksheet->fromArray($data['info_lain'],NULL,'AI33');
		$worksheet->fromArray($data['info_umum'],NULL,'AQ33');
	...
	public function upload_file_template_xls(){
        ...
        while ($eof == false){
            ...
            $idget = $this->ExcelsModel->get_klasifikasi($klasifikasi);
	...
	public function download_template_upload_()
    {
        ...
        $spreadsheet->getSheetByName('MDNegara')->fromArray($countries,NULL,'A2')->setSheetState(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN);
        $spreadsheet->getSheetByName('MDProvinsi')->fromArray($propinsi,NULL,'A2')->setSheetState(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN);
        $spreadsheet->getSheetByName('MDKota')->fromArray($kota,NULL,'A2')->setSheetState(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN);
        $spreadsheet->getSheetByName('MDPekerjaan')->fromArray($kerjaan,NULL,'A2')->setSheetState(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN);
        $spreadsheet->getSheetByName('MDJenisKomoditi')->fromArray($komoditi,NULL,'A2')->setSheetState(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN);
        $spreadsheet->getSheetByName('MDLayanan')->fromArray($layanan,NULL,'A2')->setSheetState(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN);
        $spreadsheet->getSheetByName('MDKlasifikasi')->fromArray($klasifikasi,NULL,'A2')->setSheetState(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN);
        $spreadsheet->getSheetByName('MDSubklasifikasi')->fromArray($subklasifikasi,NULL,'A2')->setSheetState(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN);
        ...
        for($column = 5; $column < 105; $column++){
            ...
            $validation->setFormula1('=\'MDNegara\'!$B$2:$B$'.count($countries));
            ...
            $validation->setPromptTitle('Pick from list');
            $validation->setPrompt('Please pick a value from the drop-down list.');
            $validation->setFormula1('=\'MDProvinsi\'!$B$2:$B$'.count($propinsi));
            ...
            $validation->setPromptTitle('Pick from list');
            $validation->setPrompt('Please pick a value from the drop-down list.');
            $validation->setFormula1('=\'MDKota\'!$B$2:$B$'.count($kota));
            ...
            $validation->setPromptTitle('Pick from list');
            $validation->setPrompt('Please pick a value from the drop-down list.');
            $validation->setFormula1('=\'MDPekerjaan\'!$B$2:$B$'.count($kerjaan));
            ...
            $validation->setPromptTitle('Pick from list');
            $validation->setPrompt('Please pick a value from the drop-down list.');
            $validation->setFormula1('=\'MDJenisKomoditi\'!$B$2:$B$'.count($komoditi));
            ...
            $validation->setPromptTitle('Pick from list');
            $validation->setPrompt('Please pick a value from the drop-down list.');
            $validation->setFormula1('=\'MDLayanan\'!$B$2:$B$'.count($layanan));
            ...
            $validation->setPromptTitle('Pick from list');
            $validation->setPrompt('Please pick a value from the drop-down list.');
            $validation->setFormula1('=\'MDKlasifikasi\'!$B$2:$B$'.count($klasifikasi));
            ...
            $validation->setPromptTitle('Pick from list');
            $validation->setPrompt('Please pick a value from the drop-down list.');
            $validation->setFormula1('=\'MDSubklasifikasi\'!$B$2:$B$'.count($subklasifikasi));
