...
class Dashboard extends Secure_Controller
{
	...
	public function ppid_sp4n_all($jenis)
	{
		$pusat = $this->Ajax->ppid_sp4n_pusat($this->session->dashboard_date1, $this->session->dashboard_date2, $jenis);
		$cc = $this->Ajax->ppid_sp4n_cc($this->session->dashboard_date1, $this->session->dashboard_date2, $jenis);
