...
class Ppid extends Secure_Controller
{
	...
	*/
	public function search()
	{
		...
		$is_lengkap = $this->input->get('is_lengkap');
	...
	*/
	...
	public function print_ppid_word1($item_id = -1)
	{
		...
		$table->addCell(1750)->addImage(
			'../public/assets/images/bpom.png',
			array(
				//'width' => 550, 
	...
	public function print_ppid_word5($item_id = -1)
	{
		...
		$footer->firstPage();
		$footer->addImage(
			'../public/assets/images/footer1.png',
			array(
