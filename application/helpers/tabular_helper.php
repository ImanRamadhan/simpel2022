...
function get_ppid_data_row($item, $no)
{
	...
	$view_link = anchor(
		$controller_name . "/view/$item->id?r=" . rand(1000, 9999),
		"<i class='fa fa-search-plus'></i>",
		array('class' => '', 'data-btn-submit' => $CI->lang->line('common_submit'), 'title' => $CI->lang->line($controller_name . '_view'))
	);
	$edit_link = anchor(
		$controller_name . "/edit/$item->id",
		"<i class='fa fa-fw fa-pencil-alt'></i>",
		array('class' => '', 'data-btn-submit' => $CI->lang->line('common_submit'), 'title' => $CI->lang->line($controller_name . '_edit'))
	);
...
function get_rujukanmasuk_ticket_data_row($item, $no)
{
	...
	$view_link = anchor(
		"rujukan/view/$item->id?ref=rujukan_masuk&r=" . rand(1000, 9999),
		"<i class='fa fa-search-plus'></i>",
...
function get_rujukankeluarsaya_ticket_data_row($item, $no)
{
	...
	$view_link = anchor(
		"tickets/view/$item->id?ref=rujukan_keluar_saya&r=" . rand(1000, 9999),
		"<i class='fa fa-search-plus'></i>",
		array('class' => '', 'data-btn-submit' => $CI->lang->line('common_submit'), 'title' => $CI->lang->line('tickets_view'))
	);
	$edit_link = anchor(
...
function get_rujukankeluar_ticket_data_row($item, $no)
{
	...
	$view_link = anchor(
		"tickets/view/$item->id?ref=rujukan_keluar&r=" . rand(1000, 9999),
		"<i class='fa fa-search-plus'></i>",
		array('class' => '', 'data-btn-submit' => $CI->lang->line('common_submit'), 'title' => $CI->lang->line('tickets_view'))
	);
	$edit_link = anchor(
...
function get_rujukanstatusclosed_ticket_data_row($item, $no)
{
	...
	$view_link = anchor(
		"tickets/view/$item->id?ref=rujukan_status_closed&r=" . rand(1000, 9999),
		"<i class='fa fa-search-plus'></i>",
		array('class' => '', 'data-btn-submit' => $CI->lang->line('common_submit'), 'title' => $CI->lang->line('tickets_view'))
	);
	$edit_link = anchor(
...
function get_rujukanstatustl_ticket_data_row($item, $no)
{
	...
	$view_link = anchor(
		"tickets/view/$item->id?ref=rujukan_status_tl&r=" . rand(1000, 9999),
		"<i class='fa fa-search-plus'></i>",
		array('class' => '', 'data-btn-submit' => $CI->lang->line('common_submit'), 'title' => $CI->lang->line('tickets_view'))
	);
	$edit_link = anchor(
...
function get_rujukanstatusfb_ticket_data_row($item, $no)
{
	...
	$view_link = anchor(
		"tickets/view/$item->id?ref=rujukan_status_fb&r=" . rand(1000, 9999),
		"<i class='fa fa-search-plus'></i>",
		array('class' => '', 'data-btn-submit' => $CI->lang->line('common_submit'), 'title' => $CI->lang->line('tickets_view'))
	);
	$edit_link = anchor(
...
function get_my_ticket_data_row($item, $no)
{
	...
	$view_link = anchor(
		$controller_name . "/view/$item->id?ref=layanan_saya&r=" . rand(1000, 9999),
		"<i class='fa fa-search-plus'></i>",
		array('class' => '', 'data-btn-submit' => $CI->lang->line('common_submit'), 'title' => $CI->lang->line('tickets_view'))
	);
	$edit_link = anchor(
	...
	$pdf_link = anchor(
		$controller_name . "/print_pdf/$item->id",
		"<i class='fa fa-print'></i>",
		array('class' => '', 'data-btn-submit' => $CI->lang->line('common_submit'), 'title' => $CI->lang->line('tickets_pdf'))
	);
...
function get_yanblik_ticket_data_row($item, $no)
{
	...
	$view_link = anchor(
		"tickets/view/$item->id?ref=layanan_yanblik&r=" . rand(1000, 9999),
		"<i class='fa fa-search-plus'></i>",
		array('class' => '', 'data-btn-submit' => $CI->lang->line('common_submit'), 'title' => $CI->lang->line('tickets_view'))
	);
	$edit_link = anchor(
