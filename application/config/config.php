...
|
*/
$config['encryption_key'] = getenv('ENCRYPTION_KEY') ? getenv('ENCRYPTION_KEY') : 'ETGxQDQ8k9ySp44NnGlZH4BdRPNd4RFS';
...
$config['sess_cookie_name'] = 'simpellpk_beta_a';
...
$config['csrf_token_name'] = 'csrf_simpellpk_beta_a';
