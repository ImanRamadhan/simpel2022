...
class Module extends CI_Model
{
	...
	public function get_allowed_home_modules($user_id)
	{
	...
	public function get_allowed_master_modules($user_id)
	{
		$menus = array('master', 'both');
		$this->db->from('modules');
		$this->db->join('permissions', 'permissions.permission_id = modules.module_id');
		$this->db->join('grants', 'permissions.permission_id = grants.permission_id');
		$this->db->where('user_id', $user_id);
	...
	public function get_allowed_admin_modules($user_id)
	{
		$menus = array('admin', 'both');
		$this->db->from('modules');
		$this->db->join('permissions', 'permissions.permission_id = modules.module_id');
		$this->db->join('grants', 'permissions.permission_id = grants.permission_id');
		$this->db->where('user_id', $user_id);
	...
	public function get_allowed_report_modules($user_id)
	{
		$menus = array('reports', 'both');
		$this->db->from('modules');
		$this->db->join('permissions', 'permissions.permission_id = modules.module_id');
		$this->db->join('grants', 'permissions.permission_id = grants.permission_id');
		$this->db->where('user_id', $user_id);
	...
	public function get_allowed_trx_modules($user_id)
	{
		$menus = array('trx', 'both');
		$this->db->from('modules');
		$this->db->join('permissions', 'permissions.permission_id = modules.module_id');
		$this->db->join('grants', 'permissions.permission_id = grants.permission_id');
		$this->db->where('user_id', $user_id);
